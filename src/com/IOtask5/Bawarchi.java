...
public class Bawarchi implements Resturent, Serializable
{
		public void rest()
		{
			Integer a;
					...
					case 1: 
						{
							...
							System.out.println("4.Chicken Fried Piece Biryani");
							nonv=sc.nextInt();
							switch (nonv) 
								{
								case 1: 
								...
								case 4: 
									{
									System.out.println("Chicken Fried Piece Biryani");
									Float rate=190.0f ;
									System.out.println("Enter Quantity Required");
									qty=sc.nextInt();
									Float subt=rate*qty;
					...
					case 2: 
						{
							...
							System.out.println("1.North Indian Tali");
							System.out.println("2.South Indian Tali");
							System.out.println("3.Veg Biryani");
							System.out.println("4.Paneer Biryani");
							veg=sc.nextInt();
							switch (veg) 
								{
								case 1: 
									{	
									System.out.println("North Indian Tali");
									Float rate=180.0f ;
									System.out.println("Enter Quantity Required");
									qty=sc.nextInt();
									Float subt=rate*qty;
								...
								case 2: 
									{
									System.out.println("South Indian Tali");
									Float rate=150.0f ;
									System.out.println("Enter Quantity Required");
									qty=sc.nextInt();
									Float subt=rate*qty;
